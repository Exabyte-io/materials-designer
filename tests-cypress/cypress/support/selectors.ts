...
export const SELECTORS = {
    ...
    sourceEditor: {
        ...
        basisEditor: {
            ...
            basisUnitsByName: (name: string) => `#basis-units-' + ${name}`,
        },
        latticeEditor: {
            ...
            latticeOptionSelectorByNameSelect: (name: string) => `select[name="${name}"]`,
            latticeFormSaveButton: "button.save-lattice-config",
        },
    },
    sAlertWidget: {
        wrapper: ".alert.s-alert-box",
        alertByType: (type: string) => `.alert-${type}`,
        closeButton: "button.close",
    },
    threeJSEditorWidget: {
        wrapper: "#threejs-editor",
        viewport: "#threejs-editor #viewport",
        menuByTitle: (title: string) => `//div[@class="menu"] //div[starts-with(text(),"${title}")]`,
        menuItemByTitle: (title: string) =>

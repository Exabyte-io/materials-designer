...
declare class JupyterLiteTransformation extends React.Component<JupyterLiteTransformationProps, JupyterLiteTransformationState> {
    messageHandler: MessageHandler;
    constructor(props: JupyterLiteTransformationProps);
    componentDidMount(): void;
    componentDidUpdate(prevProps: JupyterLiteTransformationProps): void;

                    ...
                    <div className="row" id="supercell-matrix">
                        <div className="col-xs-4 form-group fg-float">
                            <div className="fg-line ">
                                <input
                                    type="number" className="form-control fg-input m11" step="1"
                                    value={this.state.m11} tabIndex="1"
                                    onChange={(e) => {
                        ...
                        <div className="col-xs-4 form-group fg-float">
                            <div className="fg-line ">
                                <input
                                    type="number" className="form-control fg-input m12" step="1"
                                    value={this.state.m12} tabIndex="2"
                                    onChange={(e) => {
                        ...
                        <div className="col-xs-4 form-group fg-float">
                            <div className="fg-line ">
                                <input
                                    type="number" className="form-control fg-input m13" step="1"
                                    value={this.state.m13} tabIndex="3"
                                    onChange={(e) => {
                        ...
                        <div className="col-xs-4 form-group fg-float">
                            <div className="fg-line ">
                                <input
                                    type="number" className="form-control fg-input m21" step="1"
                                    value={this.state.m21} tabIndex="4"
                                    onChange={(e) => {
                        ...
                        <div className="col-xs-4 form-group fg-float">
                            <div className="fg-line ">
                                <input
                                    type="number" className="form-control fg-input m22" step="1"
                                    value={this.state.m22} tabIndex="5"
                                    onChange={(e) => {
                        ...
                        <div className="col-xs-4 form-group fg-float">
                            <div className="fg-line ">
                                <input
                                    type="number" className="form-control fg-input m23" step="1"
                                    value={this.state.m23} tabIndex="6"
                                    onChange={(e) => {
                        ...
                        <div className="col-xs-4 form-group fg-float">
                            <div className="fg-line ">
                                <input
                                    type="number" className="form-control fg-input m31" step="1"
                                    value={this.state.m31} tabIndex="7"
                                    onChange={(e) => {
                        ...
                        <div className="col-xs-4 form-group fg-float">
                            <div className="fg-line ">
                                <input
                                    type="number" className="form-control fg-input m32" step="1"
                                    value={this.state.m32} tabIndex="8"
                                    onChange={(e) => {
                        ...
                        <div className="col-xs-4 form-group fg-float">
                            <div className="fg-line ">
                                <input
                                    type="number" className="form-control fg-input m33" step="1"
                                    value={this.state.m33} tabIndex="9"
                                    onChange={(e) => {
            ...
            <ModalFooter className="bgm-dark">
                <div className="row">
                    <div className="col-xs-12">
                        <button id="make-supercell" className="btn btn-custom btn-block"
                            onClick={this.handleGenerateSupercell}>Submit
                        </button>
                    </div>
                </div>
                <div className="row">
